...
<div class="row">
<div class="col-sm-8">
<iframe name="order" frameborder="0" src="forwttable.jsp" height="400" width="100%"></iframe>
</div>
<div class="col-sm-4">
<iframe name='manager' frameborder='0' src='updatestatus.jsp' height='300' width='100%'></iframe>
</div></div></div>
</body>
</html>